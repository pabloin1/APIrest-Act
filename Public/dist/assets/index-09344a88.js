      ...
      e: for (var Q = 0, Z = C.length, pr = Z >>> 1; Q < pr; ) {
        ...
        if (0 > l(Vl, R))
          Ct < Z && 0 > l(hr, Vl)
            ? ((C[Q] = hr), (C[Ct] = R), (Q = Ct))
            : ((C[Q] = Vl), (C[xt] = R), (Q = xt));
        else if (Ct < Z && 0 > l(hr, R)) (C[Q] = hr), (C[Ct] = R), (Q = Ct);
        else break e;
      }
    }
    return T;
    ...
    (e.unstable_scheduleCallback = function (C, T, R) {
      ...
      return (
        ...
        R > Q
          ...
          : ((C.sortIndex = Z), t(s, C), y || w || ((y = !0), $l(x))),
        C
      );
    }),
...
function qf(e, t, n, r, l, o, i, u, s) {
  (Dn = !1), (Yr = null), Gf.apply(Zf, arguments);
}
...
var hn = {
  ...
  ql = Ee(Sd),
  Ed = H({}, hn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  kd = Ee(Ed),
  xd = H({}, hn, {
...
var Od = H({}, sr, {
  ...
  Fd = Ee(Dd),
  Ad = H({}, hn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  jd = Ee(Ad),
  Md = H({}, El, {
    deltaX: function (e) {
...
var Bd = Ze && "TextEvent" in window && !Fn,
  Ra = Ze && (!ji || (Fn && 8 < Fn && 11 >= Fn)),
...
if (Ze) {
  ...
  Da = bl && (!document.documentMode || 9 < document.documentMode);
}
function $u() {
  An && (An.detachEvent("onpropertychange", Fa), (Xn = An = null));
}
function Fa(e) {
...
function Kd(e, t, n) {
  e === "focusin"
    ? ($u(), (An = t), (Xn = n), An.attachEvent("onpropertychange", Fa))
    : e === "focusout" && $u();
}
function Jd(e) {
...
function Ja(e, t, n) {
  (ke[xe++] = Je), (ke[xe++] = Xe), (ke[xe++] = Dt), (Dt = e);
  var r = Je;
  e = Xe;
  var l = 32 - Ae(r) - 1;
  (r &= ~(1 << l)), (n += 1);
...
function hp(e, t, n) {
  ...
  if (wc(e)) Sc(t, l);
    ...
    (n = Ga(e, t, l, r)),
      n !== null && ((l = se()), je(n, e, r, l), Ec(n, t, r));
  }
}
function wc(e) {
  var t = e.alternate;
...
function hs(e, t, n, r, l) {
  return un(), Bi(l), (t.flags |= 256), ue(e, t, n, r), t.child;
}
...
function je(e, t, n, r) {
  ...
  ur(e, n, r),
    (!(F & 2) || e !== b) &&
      (e === b && (!(F & 2) && (Rl |= n), Y === 4 && ut(e, te)),
      me(e, r),
      n === 1 && F === 0 && !(t.mode & 1) && ((fn = K() + 500), _l && kt()));
}
function me(e, t) {
...
function Ot(e, t) {
  ...
  if ((n !== -1 && ((e.timeoutHandle = -1), lp(n)), J !== null))
...
function yl(e, t) {
  ...
  while (1);
  if ((Hi(), (F = n), (pl.current = r), J !== null)) throw Error(E(261));
...
Wc = function (e, t, n) {
  ...
  else (de = !1), U && t.flags & 1048576 && Ja(t, il, t.index);
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (Oi(t, n | 1), me(t, K()), !(F & 6) && ((fn = K() + 500), kt()));
      }
      break;
    case 13:
      jt(function () {
    ...
    return (
      ...
      s
        ...
        : ((!l[i] || !v.isObject(l[i])) && (l[i] = []),
          t(n, r, l[i], o) && v.isArray(l[i]) && (l[i] = jh(l[i])),
          !u)
    );
  }
    ...
    function (t, n) {
      ...
      if (o) {
        if (r.indexOf("application/x-www-form-urlencoded") > -1)
          return Fh(t, this.formSerializer).toString();
      ...
      return new Promise(function (n, r) {
        ...
        l === void 0 && o.setContentType(null),
          ...
          typeof e.onDownloadProgress == "function" &&
            a.addEventListener("progress", Ds(e.onDownloadProgress, !0)),
          typeof e.onUploadProgress == "function" &&
            a.upload &&
            a.upload.addEventListener("progress", Ds(e.onUploadProgress)),
...
function um() {
  const [e, t] = $n.useState(""),
    ...
    o = () => {
      r(!1);
      const i =
        "https://api-descargas.onrender.com/enviarCorreo/descargar-musica";
      im.get(i, { params: { url: e }, responseType: "blob" })
        .then((u) => {
          if (u.status === 200) {
            const s = new Blob([u.data], { type: "audio/mpeg" }),
              a = URL.createObjectURL(s),
              p = document.createElement("a");
            (p.href = a), (p.download = "audio.mp3"), p.click(), r(!0);
          } else throw new Error("Error al descargar el audio desde la API.");
        })
        .catch((u) => {
  ...
  return Ce.jsxs("div", {
    ...
    children: [
      Ce.jsx("input", {
        ...
        className:
          "w-96 text-center border border-solid border-2 border-black py-2 mb-3",
        value: e,
        onChange: l,
      }),
      n
        ? Ce.jsx("button", {
            ...
            onClick: o,
            children: "Bajar música",
          })
        : Ce.jsx("div", { children: "Descargando..." }),
    ],
  });
}
function sm() {
  return Ce.jsx("h1", {
    className: "text-blue-700 font-black text-3xl mb-5",
    children: "Download your music here!",
  });
}
function am() {
  return Ce.jsxs("div", {
    className: "bg-gray-100 p-20 rounded-lg shadow-md shadow-black",
    children: [Ce.jsx(sm, {}), Ce.jsx(um, {})],
  });
}
function cm() {
  return Ce.jsx("div", {
...
Eo.createRoot(document.getElementById("root")).render(
  Ce.jsx(Df.StrictMode, { children: Ce.jsx(cm, {}) })
);
